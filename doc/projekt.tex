...
There are to ways how to run program:\newline

\begin{itemize}
\item with simple bash script (only difference is that bash script also runs time program to measure time)
\end{itemize}

\begin{codeframe}
      \begin{Verbatim}{frame=single}
$ bash project.sh <input file> 
\end{Verbatim}
    \end{codeframe}

\begin{itemize}
\item with ruby interpreter
\end{itemize}

\begin{codeframe}
      \begin{Verbatim}{frame=single}
$ ruby project.rb <input file> 
\end{Verbatim}
    \end{codeframe}
\end{document}
